...
/* RWP */
static int predicted_dirty_partition_size; /* number of ways for dirty partition */
...
sim_reg_options(struct opt_odb_t *odb)
{
    ...
    opt_reg_note(odb,
                 ...
                 "    <repl>   - block replacement strategy, 'l'-LRU, 'f'-FIFO, 'r'-random, 'p'-RWP\n" /* RWP */
                 "\n"
    ...
    /* RWP: add options for dirty partition size */
    opt_reg_int(odb, "-rwp:size", "number of ways for dirty partition",
                &predicted_dirty_partition_size, /* default */ 0,
                /* print */TRUE, NULL);
}
    ...
    else /* dl1 is defined */
    {
        ...
        else
        {
            ...
            cache_dl2 = cache_create(name, nsets, bsize, /* balloc */FALSE,
                                     /* usize */0, assoc, cache_char2policy(c),
                                     dl2_access_fn, /* hit lat */cache_dl2_lat, predicted_dirty_partition_size); /* RWP: initialize predicted partition size */
        }
    }
